...
import { type LogEntry, type Phase, short } from './config';

// ── Phase progress bar ────────────────────────────────────────────────────────

export const PHASES_P1: Phase[] = ['preflight', 'init', 'fund', 'utxos', 'channel', 'b_init', 'b_channel', 'lsp_flow', 'rgb_send', 'settle'];
